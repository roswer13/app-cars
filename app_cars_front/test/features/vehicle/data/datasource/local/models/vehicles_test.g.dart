...
class $$VehiclesTableFilterComposer
    extends Composer<_$TestDatabase, $VehiclesTable> {
...
class $$VehiclesTableTableManager
    extends
        RootTableManager<
          ...
          (Vehicle, BaseReferences<_$TestDatabase, $VehiclesTable, Vehicle>),
          Vehicle,
          PrefetchHooks Function()
        > {
  $$VehiclesTableTableManager(_$TestDatabase db, $VehiclesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
