    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.CharField(help_text='Account name of the user.', max_length=128, unique=True, verbose_name='Account')),
                ('phone', models.CharField(help_text='Phone number of the user.', max_length=15, verbose_name='Phone')),
